...
public class VelcroArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.VELCRO,
                            List.of(new MobEffectInstance(ModEffects.VELCRO, 40, 0, false, false))).build();
    public VelcroArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
