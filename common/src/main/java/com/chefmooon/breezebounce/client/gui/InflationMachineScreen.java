...
public class InflationMachineScreen extends AbstractContainerScreen<InflationMachineMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float f, int i, int j) {
        ...
        if (this.menu.isInflate()) {
            ...
            guiGraphics.blit(RenderType::guiTextured, BACKGROUND_TEXTURE, this.leftPos + INFLATION_ICON.x, this.topPos + INFLATION_ICON.y + (17 - l), 176, 17 - l, INFLATION_ICON.width, l, 256, 256);
        }
    }
}
